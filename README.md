...
| server_ip | `STRING` | The IP address of the DNS server this query was sent to. |
| server_port | `INT` | The UDP port of the DNS server this query was sent to. |
| server_ip | `STRING` | The IP address this query was sent from. |
| server_port | `INT` | The UDP port this query was sent from. |
